...
__all__ = [
    'SPRST_INACTIVE', 'DISPID_SVGetAudioOutputs', 'SpeechAllElements',
    'SpeechTokenKeyAttributes', 'DISPID_SPRulesCount',
    'ISpeechRecognizerStatus', 'DISPID_SVSpeakStream', 'SINone',
    'SPXMLRESULTOPTIONS', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SRGRules', 'DISPID_SPERequiredConfidence',
    'SAFT48kHz16BitStereo', 'SPSHORTCUTTYPE', 'SP_VISEME_20',
    'ISpNotifySink', 'ISpeechLexiconWords', 'SPRST_NUM_STATES',
    'SpUnCompressedLexicon', 'SGRSTTWord', 'eLEXTYPE_MORPHOLOGY',
    'SPCT_COMMAND', 'SVEAudioLevel', 'DISPID_SPPValue',
    'ISpeechPhraseAlternate', 'SAFT11kHz16BitMono', 'DISPID_SLWWord',
    'DISPID_SPEDisplayText', 'SVP_12', 'SVSFParseMask', 'SVP_16',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechRetainedAudioOptions',
    'DISPID_SPIProperties', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPRText', 'tagSPPROPERTYINFO',
    'DISPID_SPIStartTime', 'SpCompressedLexicon',
    'DISPID_SLAddPronunciationByPhoneIds', 'SRAExport', 'SVP_21',
    'DISPID_SWFESamplesPerSec', 'SVP_15', 'STCRemoteServer',
    'ISpObjectToken', 'SpeechGrammarRuleStateTransitionType',
    'SPSInterjection', 'DISPID_SpeechPhoneConverter', 'SP_VISEME_2',
    'ISpeechGrammarRule', 'DISPID_SRCRetainedAudio',
    'eLEXTYPE_RESERVED4', 'SVP_18', 'DISPIDSPTSI_ActiveLength',
    'SpeechVoiceSpeakFlags', 'DISPID_SASCurrentDevicePosition',
    'SPEI_START_INPUT_STREAM', 'DISPID_SGRInitialState',
    'ISpeechAudioFormat', 'SpTextSelectionInformation',
    'STSF_AppData', 'SAFT48kHz16BitMono', 'DISPID_SGRsAdd',
    'DISPID_SRRTimes', 'DISPID_SPRFirstElement',
    'SAFTGSM610_8kHzMono', 'DISPID_SOTsCount', 'SGLexical',
    'DISPID_SGRSTPropertyValue', 'SPPS_Noncontent', 'SPWF_INPUT',
    'STSF_LocalAppData', 'SREPropertyStringChange',
    'DISPID_SOTDisplayUI', 'SpeechCategoryAppLexicons',
    'DISPID_SVEStreamEnd', 'DISPID_SpeechLexiconProns',
    'DISPID_SVESentenceBoundary', 'ISpeechObjectToken',
    'SpeechSpecialTransitionType', 'SPAO_RETAIN_AUDIO',
    'DISPID_SBSWrite', 'DISPID_SGRSRule', 'DISPID_SVEStreamStart',
    'DISPID_SOTCEnumerateTokens', 'SVSFNLPMask', 'SRSInactive',
    'DISPID_SpeechLexicon', 'SVP_2', 'DISPID_SRGCmdLoadFromResource',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPPChildren', 'SP_VISEME_13',
    'DISPID_SBSSeek', 'SVP_3', 'DISPID_SPIGetText',
    'DISPID_SPILanguageId', 'DISPID_SAFGetWaveFormatEx',
    'SpeechCategoryRecoProfiles', 'SAFTGSM610_22kHzMono',
    'SAFTCCITT_ALaw_44kHzMono', 'SRSActive', 'DISPID_SAStatus',
    'DISPID_SpeechLexiconWords', 'ISpPhrase', 'SREPropertyNumChange',
    'SPGS_ENABLED', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechRecognizerStatus', 'SpeechTokenShellFolder',
    'SPEI_VISEME', 'SRAORetainAudio', 'SPEI_PHRASE_START',
    'DISPID_SRGDictationUnload', 'SPWT_PRONUNCIATION', 'SPWT_LEXICAL',
    'SPINTERFERENCE_TOOSLOW', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SGRSTransitions', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SGRsCommit', 'DISPID_SLWs_NewEnum', 'SPAUDIOOPTIONS',
    'eLEXTYPE_PRIVATE6', 'SPEI_SOUND_END', 'DISPID_SLWPronunciations',
    'DISPID_SPIRule', 'ISpVoice', 'IInternetSecurityMgrSite',
    'SDKLDefaultLocation', 'SPEI_START_SR_STREAM',
    'DISPID_SMSGetData', 'DISPID_SVSInputWordLength',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE15', 'SDKLCurrentConfig', 'SGSExclusive',
    'SPPS_Verb', 'SpeechCategoryVoices', 'SVSFParseAutodetect',
    'SpeechTokenKeyFiles', 'ISpeechRecoContext', 'SGRSTTRule',
    'IInternetSecurityManager', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SOTCreateInstance',
    'SVEViseme', 'ISpeechGrammarRuleStateTransitions',
    'SpInprocRecognizer', 'SDA_One_Trailing_Space',
    'DISPID_SGRSTPropertyName', 'ISpeechCustomStream',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRRTTickCount', 'SPWORDLIST',
    'SpeechVisemeFeature', 'SAFT44kHz8BitMono', 'SRTEmulated',
    'DISPID_SRCEFalseRecognition', 'DISPID_SBSRead',
    'DISPID_SRCBookmark', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRSAddWordTransition', 'SVPAlert', 'DISPID_SPAsCount',
    'SpeechVoiceEvents', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISequentialStream', 'SPLEXICONTYPE', 'SpMMAudioIn', 'ISpLexicon',
    'DISPID_SRGetPropertyString', 'SPWORDPRONUNCIATION',
    'DISPID_SAFSetWaveFormatEx', 'SPPHRASEELEMENT',
    'SREFalseRecognition', 'SPWORDPRONUNCIATIONLIST',
    'SAFT8kHz8BitMono', 'SP_VISEME_16', 'DISPID_SDKDeleteKey',
    'SVSFVoiceMask', 'SpeechLoadOption', 'SPPS_Noun',
    'SECHighConfidence', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechXMLRecoResult', 'ISpNotifyTranslator', 'SPPHRASE',
    'SPPS_SuppressWord', 'SBONone', 'DISPID_SPCLangId',
    'STCLocalServer', 'SpNullPhoneConverter', 'ISpeechPhraseProperty',
    'SAFTADPCM_11kHzStereo', 'SVP_6', 'DISPID_SPEActualConfidence',
    'DISPID_SVSInputSentenceLength', 'SPRST_ACTIVE',
    'eLEXTYPE_PRIVATE10', 'SpeechDiscardType', 'SVEPhoneme',
    'eLEXTYPE_PRIVATE14', 'SPSUnknown', 'DISPID_SWFEBlockAlign',
    'SPSMF_UPS', 'SVP_19', 'SPPS_LMA', 'DISPID_SLWsCount',
    'SPFM_OPEN_READWRITE', 'DISPID_SLPsItem',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SMSSetData', 'SGDisplay',
    'ISpResourceManager', 'eLEXTYPE_PRIVATE20', 'SPEI_RESERVED1',
    'SpeechEngineProperties', 'SAFTCCITT_uLaw_11kHzMono',
    'SPINTERFERENCE', 'SDA_Two_Trailing_Spaces', 'SP_VISEME_0',
    'SpeechPartOfSpeech', 'DISPID_SpeechPhraseProperty',
    'DISPID_SGRAttributes', 'DISPID_SVRate', '__MIDL_IWinTypes_0009',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPEsCount', 'SpCustomStream',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SpeechDataKey',
    'DISPID_SPEAudioTimeOffset', 'SPEI_RECO_STATE_CHANGE',
    'SP_VISEME_17', 'SPGRAMMARSTATE', 'DISPID_SGRId',
    'DISPID_SLGenerationId', 'eLEXTYPE_RESERVED9',
    'DISPID_SVSRunningState', 'SPSNoun', 'SGSDisabled',
    'ISpeechXMLRecoResult', 'DISPID_SPPFirstElement',
    'SGDSActiveUserDelimited', 'SPEI_END_INPUT_STREAM', 'DISPIDSPTSI',
    'DISPID_SpeechRecoResult', 'SpeechAudioState',
    'DISPID_SVPriority', 'SECFNoSpecialChars', 'SpeechFormatType',
    'DISPID_SPIGrammarId', 'DISPID_SRRTStreamTime', 'SVF_Emphasis',
    'SFTSREngine', 'SAFT32kHz8BitStereo', 'DISPID_SpeechPhraseRules',
    'DISPID_SRSCurrentStreamPosition', 'SVF_None', 'SPAR_High',
    'DISPID_SRCEventInterests', 'ISpeechPhraseAlternates',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRRAudioFormat',
    'SPDKL_LocalMachine', 'SLTApp', 'DISPID_SPIElements', 'SRTReSent',
    'SPPHRASEPROPERTY', 'DISPID_SPEAudioStreamOffset',
    'SpSharedRecognizer', 'SVSFlagsAsync', 'SPRULESTATE',
    'SREStateChange', 'DISPID_SRRTLength',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SGRsCount', 'SRSEDone',
    'SAFT8kHz16BitStereo', 'SPEI_RESERVED2', 'SAFTADPCM_22kHzStereo',
    'SpeechPropertyResponseSpeed', 'SAFTCCITT_ALaw_11kHzStereo',
    'SDTReplacement', 'DISPID_SLGetPronunciations', 'SSTTTextBuffer',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPPS_Modifier',
    'DISPID_SRCEPropertyStringChange', 'SPPHRASERULE',
    'DISPID_SRCERequestUI', 'SVEVoiceChange', 'DISPID_SVEAudioLevel',
    'SPBO_AHEAD', 'SAFTADPCM_44kHzMono', 'SpMMAudioEnum',
    'SVEEndInputStream', 'ISpeechObjectTokenCategory',
    'SREInterference', 'SPBO_TIME_UNITS', 'DISPID_SRCRequestedUIType',
    'SPPARTOFSPEECH', 'SWPUnknownWordUnpronounceable',
    'SAFT22kHz16BitMono', 'DISPID_SRRGetXMLResult',
    'ISpeechPhraseReplacements', 'tagSTATSTG', 'SpeechRuleAttributes',
    'DISPID_SLWLangId', 'SP_VISEME_1', 'DISPID_SWFEAvgBytesPerSec',
    'SVSFPurgeBeforeSpeak', 'SpeechRecognitionType', 'SAFTDefault',
    'SpeechCategoryPhoneConverters', 'DISPID_SWFEChannels',
    'SPVPRI_NORMAL', 'ISpStream', 'SPCS_DISABLED', 'SGPronounciation',
    'SPSHT_Unknown', 'STSF_FlagCreate', 'SECFDefault',
    'SpObjectToken', 'DISPID_SGRsDynamic', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGDictationLoad', 'DISPID_SpeechVoiceEvent',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRCEAudioLevel',
    'SPEI_ADAPTATION', 'SGLexicalNoSpecialChars', 'SREPhraseStart',
    'DISPID_SRCState', 'DISPID_SGRAddResource', 'SPEI_MAX_TTS',
    'DISPID_SOTMatchesAttributes', 'DISPID_SVEBookmark',
    'ISpeechRecognizer', 'DISPID_SRCResume', 'ISpPhoneConverter',
    'ISpeechPhraseElements', 'DISPID_SRCESoundEnd',
    'DISPID_SPAStartElementInResult', 'SpStreamFormatConverter',
    'SPCS_ENABLED', 'SPVPRIORITY', 'DISPID_SLGetGenerationChange',
    'DISPID_SPRuleChildren', 'STCInprocServer', 'SSFMCreate',
    'ISpeechGrammarRuleStateTransition', 'ISpRecoResult',
    'DISPID_SRRSaveToMemory', 'DISPID_SAFType', 'SpeechRunState',
    'SpeechCategoryAudioIn', 'SRTSMLTimeout',
    'DISPID_SpeechCustomStream',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVDisplayUI',
    'SPFM_CREATE_ALWAYS', 'SPSHT_OTHER', 'SPEI_RESERVED6',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechPhraseBuilder',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechDisplayAttributes',
    '_SPAUDIOSTATE', 'SREStreamStart', 'SpNotifyTranslator',
    'DISPID_SRRTOffsetFromStart', 'SITooSlow',
    'DISPID_SpeechPhraseProperties', 'ISpeechGrammarRules',
    'ISpeechTextSelectionInformation', 'DISPID_SPAs_NewEnum',
    'DISPID_SABIMinNotification', 'SP_VISEME_21', 'SPBOOKMARKOPTIONS',
    'DISPID_SRRAlternates', 'ISpeechLexiconPronunciations',
    'ISpeechPhraseProperties', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPDKL_CurrentConfig',
    'DISPID_SRGIsPronounceable', 'SpeechStreamSeekPositionType',
    'SpObjectTokenCategory', 'SpeechAudioVolume',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRCEEnginePrivate',
    'SAFT22kHz8BitStereo', 'eLEXTYPE_PRIVATE9', 'SAFT12kHz8BitStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SVEViseme',
    'SpeechEngineConfidence', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRGRecoContext', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPRules_NewEnum', 'SPRECOCONTEXTSTATUS',
    'SRERecoOtherContext', 'DISPID_SRRAudio', 'DISPID_SpeechVoice',
    'SpeechWordType', 'DISPID_SpeechPhraseElement', 'ISpRecoCategory',
    'SAFT16kHz16BitStereo', 'SPCT_SLEEP', 'SPWORDTYPE',
    'SSSPTRelativeToEnd', 'SPSLMA', 'DISPID_SRIsShared', 'SPAS_STOP',
    'SPEI_SENTENCE_BOUNDARY', 'SPPS_RESERVED1', 'SPEI_SR_AUDIO_LEVEL',
    'SRCS_Enabled', 'DISPID_SRCEBookmark', 'DISPID_SVIsUISupported',
    'SPSHT_NotOverriden', 'SRSInactiveWithPurge', 'SLTUser',
    'DISPID_SPRuleConfidence', 'DISPID_SRGCmdLoadFromMemory',
    'SP_VISEME_10', 'DISPID_SpeechPhraseReplacement', 'UINT_PTR',
    'DISPID_SpeechGrammarRuleState', 'ISpeechAudioStatus',
    'DISPID_SpeechAudioStatus', 'DISPID_SRRPhraseInfo',
    'DISPID_SOTGetStorageFileName', 'SPRECORESULTTIMES',
    'DISPID_SRRecognizer', 'ISpRecoContext',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SECFIgnoreKanaType',
    'SSFMOpenReadWrite', 'SDTProperty', 'DISPID_SRGId',
    'DISPID_SpeechObjectTokenCategory', 'ISpShortcut', 'SVP_7',
    'SRSActiveAlways', 'SPXRO_SML', 'SPINTERFERENCE_NOISE',
    'SPFILEMODE', 'eLEXTYPE_PRIVATE11', 'DISPID_SPEEngineConfidence',
    'SVSFNLPSpeakPunc', '_RemotableHandle', 'DISPID_SRCEPhraseStart',
    'DISPID_SDKOpenKey', 'DISPID_SVSVisemeId', 'SpPhoneConverter',
    'SP_VISEME_5', 'DISPID_SOTCDefault', 'DISPID_SPPsItem',
    'ISpXMLRecoResult', 'SAFTADPCM_8kHzMono', 'SREPrivate',
    'SECFEmulateResult', 'DISPID_SRCreateRecoContext', 'SP_VISEME_3',
    'SRARoot', '_ISpeechVoiceEvents', 'SPSVerb',
    'DISPID_SRCEPropertyNumberChange', 'SpeechTokenValueCLSID',
    'DISPID_SADefaultFormat', 'DISPID_SVStatus', 'SP_VISEME_14',
    'DISPID_SAFGuid', 'DISPID_SpeechPhraseAlternates',
    'SPRECOGNIZERSTATUS', 'DISPID_SRDisplayUI',
    'DISPID_SVSInputWordPosition', 'DISPID_SVSPhonemeId',
    'SPGS_EXCLUSIVE', 'SDTRule', 'DISPID_SpeechRecoResultTimes',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechRecoResult2',
    'DISPID_SpeechAudio', 'STSF_CommonAppData', 'ISpeechDataKey',
    'SDTAudio', 'DISPID_SRCVoice', 'SRTAutopause', 'SPAS_RUN',
    'SVP_13', 'DISPID_SPIReplacements', 'SAFTNoAssignedFormat',
    'SAFT16kHz8BitMono', 'STCAll', 'SPFM_OPEN_READONLY',
    'SPSMF_SAPI_PROPERTIES', 'SPRST_INACTIVE_WITH_PURGE', 'SVP_4',
    'SVSFUnusedFlags', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SFSOpen', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPRNumberOfElements', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SOTCSetId', 'SpeechLexiconType', 'SPVPRI_OVER',
    'SpeechRuleState', 'SpeechVisemeType', 'SpeechAudioFormatType',
    'SPEI_PROPERTY_STRING_CHANGE', 'Speech_Max_Pron_Length',
    'DISPID_SOTCGetDataKey', 'SRAONone', 'SPRECOSTATE',
    'DISPID_SPANumberOfElementsInResult', 'SAFT48kHz8BitStereo',
    'SAFT22kHz16BitStereo', 'SpeechGrammarWordType', 'SASRun',
    'DISPID_SDKSetStringValue', 'SREHypothesis',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVWaitUntilDone', 'ISpeechLexiconPronunciation',
    'SpeechUserTraining', 'DISPID_SDKGetStringValue',
    'SPEI_RESERVED5', 'SPEI_WORD_BOUNDARY',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_RESERVED7', 'SVP_8',
    'SVP_0', 'SPEI_END_SR_STREAM', 'ISpeechBaseStream', 'SBOPause',
    'SWPUnknownWordPronounceable', 'DISPID_SLPPartOfSpeech',
    'SDKLCurrentUser', 'SRESoundStart', 'DISPID_SRGSetTextSelection',
    'SREBookmark', 'eWORDTYPE_ADDED', 'DISPID_SPCPhoneToId',
    'SRERequestUI', 'SPLO_STATIC', 'DISPID_SCSBaseStream',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVP_1', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFT32kHz8BitMono', 'DISPID_SGRSTType', 'tagSPTEXTSELECTIONINFO',
    'SASStop', 'SAFTADPCM_11kHzMono', 'eLEXTYPE_RESERVED6',
    'DISPID_SMSAMMHandle', 'IEnumString', 'SpeechRegistryUserRoot',
    'DISPID_SPIAudioStreamPosition', 'SVEAllEvents',
    'DISPID_SPRs_NewEnum', 'SSTTDictation',
    'DISPID_SVSInputSentencePosition', 'SPCONTEXTSTATE',
    'SECLowConfidence', 'DISPID_SOTGetDescription', 'IStream',
    'SpSharedRecoContext', 'SAFT24kHz8BitMono',
    'SpeechCategoryRecognizers', 'SpeechCategoryAudioOut',
    'SRAInterpreter', 'SPAS_PAUSE', 'DISPID_SpeechObjectTokens',
    'DISPID_SLPPhoneIds', 'SECFIgnoreCase', 'SAFTText', 'SVP_5',
    'DISPID_SGRSTRule', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRRDiscardResultInfo', 'SAFT16kHz8BitStereo',
    'DISPID_SPRuleFirstElement', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_RESERVED10', 'DISPID_SPRuleParent', 'SGSEnabled',
    'ISpPhoneticAlphabetConverter', 'DISPID_SPPConfidence',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPRDisplayAttributes',
    'SSFMOpenForRead', 'DISPID_SASState', 'DISPID_SVSLastResult',
    'SPSEMANTICERRORINFO', 'DISPID_SPRuleName', 'DISPID_SPAsItem',
    'SPDKL_CurrentUser', 'ISpeechMMSysAudio', 'DISPID_SFSClose',
    'SpeechPropertyResourceUsage', 'DISPID_SRCCreateGrammar',
    'SVSFIsNotXML', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SDA_No_Trailing_Space', 'SGRSTTTextBuffer', 'DISPID_SPPParent',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SpeechFileStream',
    'ISpeechVoiceStatus', 'SPFM_NUM_MODES',
    'DISPID_SRSNumberOfActiveRules', 'SVP_11', 'SVESentenceBoundary',
    'SPAUDIOSTATE', 'SPEI_RECOGNITION', 'SPWT_DISPLAY',
    'DISPID_SpeechGrammarRules', 'SITooFast',
    'DISPID_SLRemovePronunciation', 'DISPID_SLPLangId',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SOTCategory',
    'SAFTADPCM_22kHzMono', 'DISPID_SRGCmdLoadFromObject',
    'SpeechMicTraining', 'SPEVENTSOURCEINFO', 'SREAdaptation',
    'ISpeechWaveFormatEx', 'SPPS_Unknown', 'ISpAudio',
    'ISpeechAudioBufferInfo', 'DISPID_SASNonBlockingIO',
    'SPEI_MIN_TTS', 'SPEI_TTS_AUDIO_LEVEL', 'SPINTERFERENCE_TOOLOUD',
    'SITooQuiet', 'DISPID_SVPause', 'SGRSTTDictation',
    'DISPID_SpeechRecoContext', 'DISPID_SABufferInfo',
    'SVEStartInputStream', 'SP_VISEME_9', 'SPSHORTCUTPAIRLIST',
    'SPINTERFERENCE_NONE', 'SREAllEvents', 'DISPID_SPRsCount',
    'ISpeechResourceLoader', 'DISPID_SRGDictationSetState',
    'SpeechAudioProperties', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SABIEventBias',
    'SPSModifier', 'SPLOADOPTIONS', 'eLEXTYPE_PRIVATE13',
    'SpeechRecoContextState', 'ISpRecognizer',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechGrammarTagDictation',
    'SPDATAKEYLOCATION', 'DISPID_SGRSAddSpecialTransition',
    'SpeechDataKeyLocation', 'SGDSActiveWithAutoPause',
    'SPINTERFERENCE_NOSIGNAL', 'SPEI_SR_PRIVATE',
    'DISPID_SpeechPhraseRule', 'SVP_14', 'DISPID_SpeechGrammarRule',
    'ISpPhoneticAlphabetSelection', 'DISPID_SLWsItem', 'SVP_20',
    'SpeechVoicePriority', 'DISPID_SRRSetTextFeedback',
    'SVEWordBoundary', 'DISPID_SVEEnginePrivate', 'SPEVENTENUM',
    'SpPhraseInfoBuilder', 'ISpDataKey', 'DISPID_SRCEAdaptation',
    'DISPID_SVSkip', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SGRSTsCount', 'DISPID_SOTId', 'DISPID_SLWType',
    'SpeechTokenIdUserLexicon', 'SPPS_NotOverriden',
    'SpeechAudioFormatGUIDWave',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SINoSignal',
    'ISpStreamFormatConverter', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRSetPropertyString', 'DISPID_SGRSTs_NewEnum',
    'SDTAlternates', 'ISpGrammarBuilder', 'DISPID_SRGReset',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRIsUISupported',
    'SECNormalConfidence', 'WAVEFORMATEX', 'DISPID_SPRuleId',
    'DISPID_SRCPause', 'SpeechTokenKeyUI', 'SpeechRecoEvents',
    'SP_VISEME_18', 'SGRSTTWildcard', 'SSSPTRelativeToStart',
    'eLEXTYPE_PRIVATE12', 'Speech_Max_Word_Length', 'SRATopLevel',
    'DISPID_SPIEnginePrivateData', 'DISPID_SOTDataKey', 'SVEBookmark',
    'DISPID_SBSFormat', 'DISPID_SVSpeakCompleteEvent',
    'SPPS_RESERVED2', 'SVSFParseSsml', 'SPEI_RESERVED3',
    'SRTExtendableParse', 'SpeechWordPronounceable',
    'SPADAPTATIONRELEVANCE', 'ISpeechVoice',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechLexiconPronunciation',
    'SAFT11kHz8BitMono', 'SPGS_DISABLED', 'ISpeechGrammarRuleState',
    'DISPID_SPEAudioSizeTime', 'DISPID_SDKGetlongValue',
    'DISPID_SGRClear', 'SRCS_Disabled', 'SPAUDIOSTATUS',
    'DISPID_SPRsItem', 'DISPID_SGRs_NewEnum', 'ISpNotifySource',
    'DISPID_SPPId', 'SPAR_Medium', 'SAFTExtendedAudioFormat',
    'DISPID_SVVoice', 'ISpeechLexicon', 'SPSEMANTICFORMAT',
    'ISpRecognizer3', 'SP_VISEME_11',
    'DISPID_SRCERecognitionForOtherContext', 'SPEVENT',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SLPType', 'eLEXTYPE_PRIVATE8',
    'SWTDeleted', 'DISPID_SVEWord', 'DISPID_SRSClsidEngine',
    'SPSHORTCUTPAIR', 'LONG_PTR', 'ISpEventSink', 'SPAO_NONE',
    'SPBO_PAUSE', 'SpVoice', 'SECFIgnoreWidth', 'ISpMMSysAudio',
    'DISPID_SGRSTWeight', 'SPVPRI_ALERT', 'SPWF_SRENGINE',
    'SPAUDIOBUFFERINFO', 'DISPID_SLGetWords', 'SAFT44kHz16BitMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVP_9', 'DISPID_SPARecoResult',
    'DISPID_SGRSTsItem', 'DISPID_SGRSTText', 'DISPID_SLPs_NewEnum',
    'SLODynamic', 'DISPID_SRGetFormat', 'SPBINARYGRAMMAR',
    'DISPID_SVEventInterests', 'ISpeechPhraseRules', 'SVPNormal',
    'DISPID_SDKCreateKey', 'DISPID_SABufferNotifySize',
    'DISPID_SRGetRecognizers', 'SPPHRASEREPLACEMENT',
    'SPCT_SUB_DICTATION', 'SAFT24kHz8BitStereo',
    'DISPID_SOTGetAttribute', 'SPEI_VOICE_CHANGE',
    'DISPID_SRGetPropertyNumber',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SDTDisplayText',
    'ISpRecoGrammar', 'DISPID_SLAddPronunciation',
    'SPXRO_Alternates_SML', 'SDTLexicalForm',
    'DISPID_SpeechPhraseInfo', 'DISPID_SGRAddState', 'SP_VISEME_4',
    'DISPID_SPIAudioSizeBytes', 'SDTPronunciation',
    'SAFT44kHz8BitStereo', 'ISpeechMemoryStream', 'DISPID_SPACommit',
    'SPEI_MAX_SR', 'SPSNotOverriden', 'SVSFDefault',
    'eLEXTYPE_RESERVED8', 'SPEI_PHONEME', 'DISPID_SABIBufferSize',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SpeechAudioBufferInfo',
    'SAFT12kHz8BitMono', 'DISPID_SpeechObjectToken',
    'SpeechAudioFormatGUIDText', 'DISPID_SRCESoundStart',
    'ISpeechPhraseRule', 'SSFMCreateForWrite',
    'DISPID_SGRSTNextState', 'ISpeechPhoneConverter',
    'SPEI_TTS_PRIVATE', 'SVF_Stressed', 'DISPID_SRGCommit',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'eLEXTYPE_APP',
    'ISpeechPhraseReplacement', 'SAFTADPCM_44kHzStereo',
    'SpeechPropertyNormalConfidenceThreshold', 'SVSFPersistXML',
    'SpeechGrammarTagWildcard', 'DISPID_SRAudioInput',
    'SpeechGrammarState', 'SAFTNonStandardFormat', 'SPVISEMES',
    'ISpeechLexiconWord', 'DISPID_SRSSupportedLanguages',
    'SpFileStream', 'DISPID_SRCCreateResultFromMemory',
    'ISpRecoContext2', 'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE16',
    'SSTTWildcard', 'SPAS_CLOSED', 'SVSFParseSapi',
    'DISPID_SMSALineId', 'ISpeechAudio', 'SGDSActive',
    'DISPID_SPEs_NewEnum', 'DISPID_SPPName', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRRRecoContext', 'DISPID_SOTs_NewEnum', 'SPVOICESTATUS',
    'DISPID_SRCRetainedAudioFormat', 'ISpeechPhraseInfoBuilder',
    'DISPID_SpeechBaseStream', 'SPGRAMMARWORDTYPE',
    'DISPID_SPEDisplayAttributes', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVSCurrentStreamNumber', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPRuleEngineConfidence', 'SPSHT_EMAIL',
    '_ISpeechRecoContextEvents', 'ISpPhraseAlt',
    'DISPID_SRCEStartStream', 'SAFTCCITT_uLaw_22kHzMono',
    'SP_VISEME_8', 'DISPID_SDKEnumValues',
    'DISPID_SpeechPhraseAlternate', 'SPEI_INTERFERENCE',
    'DISPID_SVSpeak', 'ISpeechRecoResultTimes',
    'SAFT44kHz16BitStereo', 'SPPS_RESERVED3', 'SPEI_SR_BOOKMARK',
    'SFTInput', 'DISPID_SPISaveToMemory', 'DISPID_SRRSpeakAudio',
    'DISPID_SPEPronunciation', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechInterference', 'DISPID_SOTRemove',
    'DISPID_SpeechWaveFormatEx', 'SPEI_SOUND_START', 'SpLexicon',
    'DISPID_SPPEngineConfidence', 'DISPID_SRAudioInputStream',
    'DISPID_SGRName', 'SpeechDictationTopicSpelling',
    'ISpeechObjectTokens', 'SPSERIALIZEDRESULT', 'SpeechTokenContext',
    'SPEI_UNDEFINED', 'ISpeechFileStream', 'SpMMAudioOut', 'SPAR_Low',
    'SAFT24kHz16BitStereo', 'DISPID_SDKGetBinaryValue',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechMMSysAudio',
    'DISPID_SOTIsUISupported', 'SPSSuppressWord',
    'IEnumSpObjectTokens', 'DISPIDSPRG', 'DISPID_SRCERecognition',
    'DISPID_SpeechPhraseElements', 'DISPID_SVResume', 'SGDSInactive',
    'SPEI_FALSE_RECOGNITION', 'ISpEventSource', 'ISpRecoGrammar2',
    'SPAR_Unknown', 'DISPID_SOTSetId', 'SVPOver', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPPsCount', 'eWORDTYPE_DELETED', 'SREAudioLevel',
    'DISPID_SRCSetAdaptationData', 'DISPID_SAVolume',
    'DISPID_SRSAudioStatus', 'SpShortcut',
    'DISPID_SRSCurrentStreamNumber', 'SPRULE', 'DISPID_SRStatus',
    'DISPID_SRState', 'SAFTCCITT_ALaw_22kHzStereo',
    'Speech_StreamPos_Asap', 'DISPID_SAEventHandle',
    'DISPID_SPELexicalForm', 'SINoise', 'STCInprocHandler',
    'DISPID_SpeechRecoResult2', 'DISPID_SWFEBitsPerSample',
    'DISPID_SLPsCount', 'SAFT11kHz8BitStereo', 'SpStream',
    'DISPID_SGRSTPropertyId', 'SRSEIsSpeaking', 'ISpRecognizer2',
    'SPRS_INACTIVE', 'SLOStatic', 'SPPS_RESERVED4', 'SPFM_CREATE',
    'SRAImport', 'SAFTCCITT_uLaw_44kHzStereo', 'SpMemoryStream',
    'SP_VISEME_15', 'SP_VISEME_12', 'Speech_StreamPos_RealTime',
    'SAFT48kHz8BitMono', 'SPSFunction',
    'DISPID_SRCAudioInInterferenceStatus', 'SRADefaultToActive',
    'SAFT12kHz16BitStereo', 'SRTStandard', 'SPTEXTSELECTIONINFO',
    'ISpeechPhraseElement', 'SpeechAddRemoveWord',
    'DISPID_SPAPhraseInfo', 'eLEXTYPE_PRIVATE18',
    'SAFT32kHz16BitStereo', 'ISpeechRecoResult',
    'DISPID_SVAudioOutput', 'ISpStreamFormat',
    'DISPID_SVEVoiceChange', 'SP_VISEME_19', 'SVP_10',
    'DISPID_SVVolume', 'DISPID_SPRulesItem', 'SRESoundEnd',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPPROPERTYINFO',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SPPs_NewEnum',
    'DISPID_SVGetVoices', 'SpeechEmulationCompareFlags',
    'SpWaveFormatEx', 'Speech_Default_Weight',
    'ISpeechRecoResultDispatch', 'DISPID_SRGSetWordSequenceData',
    'SWTAdded', 'SASClosed', 'DISPID_SGRsFindRule',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SpeechRecognizer', 'SPSTREAMFORMATTYPE',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPEsItem',
    'SAFTGSM610_44kHzMono', 'DISPID_SREmulateRecognition',
    'DISPID_SMSADeviceId', 'DISPID_SOTsItem',
    'SSSPTRelativeToCurrentPosition', 'SpPhoneticAlphabetConverter',
    'SpInProcRecoContext', 'SAFT22kHz8BitMono', 'SPCATEGORYTYPE',
    'SVSFIsFilename', 'DISPID_SVGetAudioInputs', 'SAFT32kHz16BitMono',
    'SWPKnownWordPronounceable',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SASPause',
    'ISpObjectWithToken', 'ISpeechRecoGrammar', 'SAFT8kHz8BitStereo',
    'SDA_Consume_Leading_Spaces', 'eLEXTYPE_PRIVATE17',
    'SAFT8kHz16BitMono', 'DISPID_SDKDeleteValue',
    'SPEI_RECO_OTHER_CONTEXT', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SpeechRecoContextEvents',
    'ISpProperties', 'DISPID_SVGetProfiles', 'SVSFIsXML',
    'SAFTGSM610_11kHzMono', 'SpAudioFormat', 'SpeechRecognizerState',
    'SpeechRecoProfileProperties', 'SPEI_MIN_SR', 'SPWAVEFORMATTYPE',
    'SpResourceManager', 'DISPID_SPCIdToPhone', 'DISPID_SGRsItem',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechAudioFormat',
    'SpeechPropertyLowConfidenceThreshold', 'SAFTADPCM_8kHzStereo',
    'DISPID_SOTCId', 'ISpeechPhraseInfo', 'DISPID_SLPSymbolic',
    'SRADynamic', 'SP_VISEME_7', 'DISPID_SVAlertBoundary',
    'DISPID_SPIEngineId', 'SP_VISEME_6', 'DISPID_SVEPhoneme',
    'SPPS_Interjection', 'DISPID_SVSLastBookmark',
    'DISPID_SDKSetBinaryValue', 'SDKLLocalMachine',
    'SPWORDPRONOUNCEABLE', 'SPCT_DICTATION', 'eLEXTYPE_USER_SHORTCUT',
    'SPRS_ACTIVE', 'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE1',
    'eLEXTYPE_PRIVATE7', 'SPBO_NONE', 'SpeechPropertyAdaptationOn',
    'SpeechStreamFileMode', 'SPEI_REQUEST_UI', 'DISPID_SWFEFormatTag',
    'SAFT16kHz16BitMono', 'SPPS_Function', 'DISPID_SWFEExtraData',
    'DISPID_SRProfile', 'SpeechGrammarTagUnlimitedDictation',
    'SVEPrivate', 'SREStreamEnd', 'DISPID_SRCEHypothesis',
    'SpeechBookmarkOptions', 'SITooLoud', 'DISPID_SRCEEndStream',
    'SVP_17', 'eLEXTYPE_PRIVATE2', 'SGRSTTEpsilon',
    'DISPID_SRCRecognizer', 'SPEI_HYPOTHESIS', 'DISPID_SRGState',
    'SPLO_DYNAMIC', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPIAudioSizeTime', 'ISpSerializeState',
    'SAFT12kHz16BitMono', 'SPWORD', 'DISPID_SVAudioOutputStream',
    'SPCT_SUB_COMMAND', 'ISpObjectTokenCategory',
    'SAFT24kHz16BitMono', 'SDTAll', 'SPDKL_DefaultLocation',
    'DISPID_SRCEInterference', 'DISPID_SASetState', 'SRERecognition'
]

_check_version('1.1.14', 1661704641.607172)
